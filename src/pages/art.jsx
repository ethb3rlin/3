      ...
      <div className="textbox decorate-links">
        ...
        <div className="mb-8">
          ...
          <ul>
            ...
            <li>
              13.30: Panel - <strong>Art after NFTs</strong>
              <br />
          ...
          <p>
            <strong>Joan Heemskerk</strong>, a Dutch contemporary artist,
          ...
          <p>
            <strong>Vincent Trasov</strong> is a painter, video and performance
