  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>
          In fact, the world seems to have changed drastically since we last met
          in Berlin in{" "}
        ...
        <p>
          ...
          annual inflation rates of supposedly stable currencies like EUR or USD
          hitting new highs each month. Over the last two years, the global
          crackdown on privacy, freedom of movement, and the right to transact
          by governments worldwide put us on the edge of a new dark age of
          regression.
        </p>
        ...
        <p>
          ...
          cryptocurrencies and blockchain technology, certain developments leave
          a bitter aftertaste, and we fear that the most essential values are
          about to get lost along the way. We take this as a call to action and
          want to do our part
        </p>
        ...
        <p>
          ...
          the system, now more than ever. We want to emphasize the original
          cypherpunk vision and build on it. In addition, we aim to teach and
          educate a new generation of hackers about what you can achieve with
        ...
        <p>
          ...
          the top to an open and an inclusive system that makes a difference in
          people's lives? Which anarchist and privacy-preserving tools can we
          build that enable independence from governments and mega corps?
        </p>
        ...
        <ul>
          ...
          <li>Libre: it will be free both as in free speech and free beer.</li>
        </ul>

        <p>
          Berlin has a dark history of financial scandals, hyperinflation, and
          bank runs. Since inflation is again about to eat the world, we'd like
          to use this as a reminder that the system we live in is not
