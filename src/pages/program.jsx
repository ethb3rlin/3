...
const Program = () => (
  <Layout>
    ...
    <div className="text-gray-50 text-justify">
      ...
      <p>
        Please note that the program below is subject to change and is just a
        rough outline. Official program will be announced soon.
      </p>
      <p className="mt-4">
        <ul>
          <li>
            <span className="fake-bold">12:00</span> Pre-registration opens
            (Creator's Lab, Courtyard 3)
          </li>
          <li>
            <span className="fake-bold">16:00</span> Registration and doors open
      ...
      <p className="mt-4">
        <li>
          <span className="fake-bold">09:00</span> Breakfast (Restaurant, Ground
          Floor)
        </li>
        <li>
        ...
        <li>
          <span className="fake-bold">20:00</span> DJ/Music (Courtyard 1, Ground
          Floor)
        </li>
        <li>
      ...
      <p className="mt-4">
        <ul>
          ...
          <li>
            <span className="fake-bold">11:00</span> Hacker Submission Deadline
            (Internet)
          </li>
          <li>
          ...
          <li>
            <span className="fake-bold">18:00</span> Doors close (Main entrance,
            Courtyard 1)
          </li>
          <li>
