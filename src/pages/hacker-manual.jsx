    ...
    <Layout>
      <div className="textbox text-base decorate-links">
        ...
        <div id="zupass">
          ...
          <p>
            This year, we have a PCD (proof-carrying data) integration with Zupass
            for ETHBerlin04. You can prove your attendance to the hackathon by generating
            a zero-knowledge proof through the Zupass web application.
          </p>
          <p>
            Visit{" "}
            <a
            ...
            and sing up (or log in) with the same email address you used to register
            for the hackathon. You will find an active ETHBerlin04 subscription
            in your account.
          </p>
          <p>
            You will require this PCD for the faucets (if needed) and the final
            submission of your hackathon project as well as voting on other people's
            projects after the hackathon concluded.
          </p>
        </div>
        <div id="connect">
        ...
        <div id="food">
          ...
          <p>
            ...
            (of course!), water, coffee and beer. In addition to <em>regular</em>{" "}
            food, there will be vegan and vegetarian options provided. Just come with an open mind, a
        ...
        <div id="hack">
          ...
          <h4 className="text-l mt-4 font-bold">Minimum Submission Requirements</h4>
          <ul>
        ...
        <div id="faucets">
          <h3 className="text-xl mt-6 font-bold">Faucets for Sepolia and Holesky</h3>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
              >holesky.ethberlin.org</a>
            </li>
          </ul>
          <p>
            You will have to sign in with Zupass to authorize a faucet drop to any
            of your addresses. Thank you, pk910 &lt;3
          </p>
        </div>
        <div id="prizes-bounties">
          ...
          <div>
            ...
            winners of each of these get <strong>5,000 DAI</strong> and these are to recognise
            the following:
          </div>
          <ul className="mt-2">
            <li>
          ...
          <div className="mt-2">
            ...
            of ETHBerlin. The winner of this track will receive <strong>4,000 DAI</strong>.
          </div>
